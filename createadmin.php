...
// REGISTER USER
  ...
  // a user does not already exist with the same username and/or email
       $user_check_query = "SELECT * FROM adminlogin WHERE username='$username' OR email='$email' LIMIT 1";
  ...
  // Finally, register user if there are no errors in the form
       if (count($errors) == 0) {
  	      ...
  	      $query = "INSERT INTO adminlogin (username, email, phnumber, password) 
  			         VALUES('$username', '$email', '$phnumber', '$password_1')";
...
<html>
   ...
   <link rel="stylesheet" href="static/createadmin.css">
   </head>
   <body>
